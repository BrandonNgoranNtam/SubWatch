...
const AuthForm = ({ type }: { type: string }) => {
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            if (type === "sign-up") {
                //const newUser = async signUp(data)
                //setUser(newUser)
            ...
            <header className='flex flex-col gap-5 md:gap-8'>
                <Link href='/' className='cursor-pointer flex items-center gap-1'>
                    <Image
                        ...
                        height={34}
                    />
                    <h1 className='text-26 font-ibm-plex-serif font-bold text-tblack-1'>SubWatch</h1>
                </Link>
                            ...
                            {type === "sign-up" && (
                                <>
                                    ...
                                    <div className='flex gap-4'>
                                        ...
                                        <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 3000" />
