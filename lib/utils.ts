 ...
 *
 * This schema defines the structure and validation rules for the authentication form.
 * It includes two fields: email and password.
 * - email: a string representing the user's email address, which must be a valid email format.
 * - password: a string representing the user's password, which must be at least 8 characters long.
 */
